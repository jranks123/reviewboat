      ...
      <section id={id} className="section" style={{ backgroundColor }}>
        ...
        <div className="icon-section">
          <div className="icon-subsection">
            <img className="pubreticon" id="retailers-icon-1" src='/rbicon1.svg'></img>
          ...
          <div className="icon-subsection">
            <img className="pubreticon" id="retailers-icon-2" src='/rbicon2.svg'></img>
          ...
          <div className="icon-subsection">
            <img className="pubreticon" id="retailers-icon-2" src='/rbicon3.svg'></img>
