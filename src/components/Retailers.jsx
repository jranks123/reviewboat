      ...
      <section id={id} class="section" style={{ backgroundColor }}>
        ...
        <div class="icon-section">
          <div class="icon-subsection">
            <img class="pubreticon" id="retailers-icon-1" src='/rbicon1.svg'></img>
          ...
          <div class="icon-subsection">
            <img class="pubreticon" id="retailers-icon-2" src='/rbicon2.svg'></img>
          ...
          <div class="icon-subsection">
            <img class="pubreticon" id="retailers-icon-2" src='/rbicon3.svg'></img>
