  ...
  return (
    <div className="section-container" style={{ backgroundColor }}>
      <section id={id} className="section" style={{ backgroundColor }}>
        <div className="publisher-retailer-leader">
        ...
        <div className="icon-section">
          <div className="icon-subsection">
            <img className="pubreticon" id="publishers-icon-1" src='/rbicon4.svg'></img>
          ...
          <div className="icon-subsection">
            <img className="pubreticon" id="publishers-icon-2" src='/rbicon5.svg'></img>
          ...
          <div className="icon-subsection">
            <img className="pubreticon" id="publishers-icon-2" src='/rbicon6.svg'></img>
