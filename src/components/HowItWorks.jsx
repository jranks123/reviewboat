    ...
    <div className="section-container" style={{ backgroundColor }}>
      <section id={id} className="section" style={{ backgroundColor }}>
        <div className="how-it-works-section-container">
          <div className="how-it-works-sub-section" id="how-section-0">
            <h2>How it works</h2>
          ...
          <div className="how-it-works-sub-section" id="how-section-1">
          ...
          <div className="how-it-works-sub-section" id="how-section-2">
          ...
          <div className="how-it-works-sub-section" id="how-section-3">
